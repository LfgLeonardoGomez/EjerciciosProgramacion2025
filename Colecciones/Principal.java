...
//      inventarioEze.ListarProductos();
        ...
        //KATA 2
        inventario.AgregarProducto(new Producto("A004", "Yerba Mate", 1500.00, 80, CategoriaProducto.ALIMENTOS));
        inventario.AgregarProducto(new Producto("E004", "Tablet", 90000.00, 12, CategoriaProducto.ELECTRONICA));
        inventario.AgregarProducto(new Producto("R004", "Zapatillas", 20000.00, 50, CategoriaProducto.ROPA));
        inventario.AgregarProducto(new Producto("H004", "Cafetera", 18000.00, 15, CategoriaProducto.HOGAR));

//      inventarioEze.BuscarProducto("H004").mostrarInfo();
        var electronica = inventario.filtrarPorCategoria("ELECTRONICA");
//        for (Producto producto : electronica) {
//            producto.mostrarInfo();
//        }

        inventario.EliminarProducto("E004");
//      inventarioEze.ListarProductos();

        //KATA 3
        inventario.AgregarProducto(new Producto("E005", "Televisor", 500.0, 10, CategoriaProducto.ELECTRONICA));
        inventario.AgregarProducto(new Producto("R005", "Camiseta", 20.0, 50, CategoriaProducto.ROPA));
        inventario.AgregarProducto(new Producto("A005", "Cereal", 5.0, 30, CategoriaProducto.ALIMENTOS));
        inventario.AgregarProducto(new Producto("H005", "Silla", 100.0, 15, CategoriaProducto.HOGAR));
        inventario.AgregarProducto(new Producto("E006", "Laptop", 1200.0, 8, CategoriaProducto.ELECTRONICA));

        System.out.println("Total de Stock: "+ inventario.ObtenerTotalStock());
        System.out.println("Prod. con + Stock: " + inventario.ObtenerProductoConMayorStock());
        ArrayList <Producto> rango = inventario.filtrarProductosPorPrecio(1000,3000);
